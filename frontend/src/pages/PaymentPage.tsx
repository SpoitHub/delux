...
export const PaymentPage = () => {
    ...
    return (
      <div className="flex flex-col items-center justify-center py-32 text-center">
        ...
        <p className="text-gray-400 text-sm mb-6">
          We couldn't find this order. It may not have been created yet.
        </p>
        <Link
          to="/"
          className="text-[#39ff14] text-xs font-bold tracking-widest uppercase hover:underline"
        >
          Go Home
        </Link>
      </div>
  ...
  if (paid) {
    return (
      <div className="flex flex-col items-center justify-center py-32 text-center">
        ...
        <p className="text-[#39ff14] text-2xl font-black mb-8">
  ...
  return (
    <div className="flex flex-col w-full pb-24">
      ...
      <Link
        to={`/orders/${order.id}`}
        className="flex items-center gap-2 text-gray-400 hover:text-white text-xs font-bold tracking-widest uppercase mb-8 transition-colors w-fit"
      >
        <ArrowLeft size={14} />
        Back to Order
      </Link>
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-[#111] border border-white/5 rounded-2xl p-6 md:p-8 space-y-5">
            ...
            <div>
              <label
                htmlFor="card-number"
                className="block text-gray-400 text-xs font-bold mb-2 uppercase tracking-widest"
              >
                Card Number
              </label>
              <input
          ...
          <div className="flex items-center gap-3 bg-[#111] border border-white/5 rounded-2xl p-4 text-gray-400 text-xs">
            ...
            <p>
              ...
              information. This is a demo — no real charges will be made.
            </p>
          </div>
        </div>
